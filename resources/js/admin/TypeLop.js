...
const Type = () => {
    document.title = "Lớp | Admin The Animals"
    ...
    const submitAddType = (e) => {
        ...
        axios({
            ...
            data: {
                type: 'lop',
                ten_lop: frmAddType.ten_lop.value,
                nganh_id: frmAddType.nganh_id.value
            }
        })
            .then(result => {
                        ...
                        <tbody>
                            <tr className="">
                                <td className="text-center text-white align-middle col-2">
                                    <label htmlFor="parent_type" className="form-label">Ngành</label>
                                    <select name="nganh_id" className="form-control text-white fs-4" id="parent_type" >
                                        {parentType.map((option) => (
                                            <option key={option.id + option.ten_nganh} value={option.id} >{option.ten_nganh}</option>
                                        ))}
                                    </select>
                                </td>
                                <td className="text-center text-white align-middle">
                                    <Input name="ten_lop" label="Lớp mới" />
                                </td>
                                <td className="text-center text-white align-middle">
                ...
                <div className="row">
                    ...
                    <form id="frmEditType" onSubmit={submitEditType}>
                        <table className="table border border-secondary rounded table-striped">
                            <thead className="">
                                <tr>
                                    <th className="fs-4 bg-light" colSpan={3}> Lớp</th>
                                </tr>
                                <tr >
                                    <th className="fs-4" scope="col">#</th>
                                    <th className="fs-4" scope="col">Tên Lớp</th>
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className="text-center text-white">
                                                ...
                                                <div className="input_edit_type d-none">
                                                    ...
                                                    <Input name="ten_lop[]" value={type.ten_lop} />
                                                </div>
                                            </td>
                                            <td className="text-center text-white">
